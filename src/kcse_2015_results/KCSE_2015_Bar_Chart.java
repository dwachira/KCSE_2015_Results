...
public class KCSE_2015_Bar_Chart extends JFrame {

   private static final long serialVersionUID = 1L;
   
   public KCSE_2015_Bar_Chart(String applicationTitle, String chartTitle, String array_dataset[][]) {
        ...
        try {
             ChartUtilities.saveChartAsPNG(new File("C:\\Users\\Wachira\\Desktop\\KCSE 2015 Bar Charts\\"+chartTitle+".png"), pieChart, width_Bar_chart,height_Bar_chart);
        } catch (IOException e) {
   ...
   private CategoryDataset createDataset(String Array_for_dataset_createDataset[][], String chartTitle) {
      ...
      // row keys...
      final String kcse_2015_candidate = chartTitle.substring(chartTitle.indexOf(" - "));
      // column keys...
      ...
      final String subject_9 = Array_for_dataset_createDataset[8][0];
      ...
      for(int i=0; i<9; i++) 
      {
            if((Array_for_dataset_createDataset[i][1] == null) || (Array_for_dataset_createDataset[i][1].length() == 0)) 
            {   //should now compile
                System.out.println("Array [" + i + "][1] --> " + "null");
                Array_for_dataset_createDataset[i][1] = "M";
            } 
      }
        
      dataset.addValue(Find_Out_Points_From_Grade(Array_for_dataset_createDataset[0][1]), kcse_2015_candidate, subject_1);
      dataset.addValue(Find_Out_Points_From_Grade(Array_for_dataset_createDataset[1][1]), kcse_2015_candidate, subject_2);
      dataset.addValue(Find_Out_Points_From_Grade(Array_for_dataset_createDataset[2][1]), kcse_2015_candidate, subject_3);
      dataset.addValue(Find_Out_Points_From_Grade(Array_for_dataset_createDataset[3][1]), kcse_2015_candidate, subject_4);
      dataset.addValue(Find_Out_Points_From_Grade(Array_for_dataset_createDataset[4][1]), kcse_2015_candidate, subject_5);
      dataset.addValue(Find_Out_Points_From_Grade(Array_for_dataset_createDataset[5][1]), kcse_2015_candidate, subject_6);
      dataset.addValue(Find_Out_Points_From_Grade(Array_for_dataset_createDataset[6][1]), kcse_2015_candidate, subject_7);
      dataset.addValue(Find_Out_Points_From_Grade(Array_for_dataset_createDataset[7][1]), kcse_2015_candidate, subject_8);
      dataset.addValue(Find_Out_Points_From_Grade(Array_for_dataset_createDataset[8][1]), kcse_2015_candidate, subject_9);
      return dataset;
