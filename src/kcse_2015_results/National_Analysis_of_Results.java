...
public void National_Analysis_of_Results ()
{
    ...
    Analysis_File_name = Analysis_File_name + "\\KCSE 2015 Analysis - " + time_of_access.replaceAll(":","-");
    Analysis_File_name = Analysis_File_name + ".txt"; 
    System.out.println(Analysis_File_name);   
}
    ...
    try
      {
            ...
            FileReader KCSE_FileReader = new FileReader("DB@254@2015KCSE.txt");   
            ...
            while (((Retrieved_Line = KCSE_Buffered_Reader.readLine())!= null))
            {
                ...
                {
                    if ( Character.isDigit(Retrieved_Line.charAt(0)) )
                    {
                        //System.out.println(calculated_number_of_candidates);
...
//                    }
                    ...
                    int index_start_of_grade = Integer.parseInt(occurrence_of_2ndtab.indexOfOccurance(Retrieved_Line, sub_string_searched, nthPositionOfThe));

                    String student_details_grade = Retrieved_Line.substring(index_start_of_grade, (index_start_of_grade+2));
//                    System.out.println(student_details_grade); 
//
//                    System.out.println(student_details_grade.charAt(0));
//                    System.out.println(student_details_grade.charAt(1));


                    if ((student_details_grade.charAt(0) == 'A') && (student_details_grade.charAt(1) == '\t'))
                    {
                    ...
                    if ((student_details_grade.charAt(0) == 'B') && (student_details_grade.charAt(1) == '+'))
                    {
                    ...
                    if ((student_details_grade.charAt(0) == 'C') && (student_details_grade.charAt(1) == '+'))
                    {
                    ...
                    if ((student_details_grade.charAt(0) == 'D') && (student_details_grade.charAt(1) == '+'))
                    {
                    ...
                    if ((student_details_grade.charAt(0) == 'E') && (student_details_grade.charAt(1) == '\t'))
                    {
                        calculated_number_of_candidates_with_E++;
                    }    
                    if ((student_details_grade.charAt(0) == 'P') && (student_details_grade.charAt(1) == '\t'))
                    {
                        calculated_number_of_candidates_with_P++;
                    }
                    if ((student_details_grade.charAt(0) == 'U') && (student_details_grade.charAt(1) == '\t'))
                    {
                        calculated_number_of_candidates_with_U++;
                    }
                    if ((student_details_grade.charAt(0) == 'W') && (student_details_grade.charAt(1) == '\t'))
                    {
                        calculated_number_of_candidates_with_W++;
                    }
                    if ((student_details_grade.charAt(0) == 'X') && (student_details_grade.charAt(1) == '\t'))
                    {
                        calculated_number_of_candidates_with_X++;
                    }
                    if ((student_details_grade.charAt(0) == 'Y') && (student_details_grade.charAt(1) == '\t'))
                    {
                        calculated_number_of_candidates_with_Y++;
                    }
                    if ((student_details_grade.charAt(0) == 'Z') && (student_details_grade.charAt(1) == '\t'))
                    {
...
/* ----------------------------------------------------------------------------------------------------------------------------- */                   
        ...
        System.out.println ("Candidates (Male & Female) with Grade:");
        System.out.println ("                A  ---> " + calculated_number_of_candidates_with_A_plain);
        System.out.println ("                A- ---> " + calculated_number_of_candidates_with_A_minus);
        System.out.println ("                B+ ---> " + calculated_number_of_candidates_with_B_plus);
        System.out.println ("                B  ---> " + calculated_number_of_candidates_with_B_plain);
        System.out.println ("                B- ---> " + calculated_number_of_candidates_with_B_minus);
        System.out.println ("                C+ ---> " + calculated_number_of_candidates_with_C_plus);
        System.out.println ("                C  ---> " + calculated_number_of_candidates_with_C_plain);
        System.out.println ("                C- ---> " + calculated_number_of_candidates_with_C_minus); 
        System.out.println ("                D+ ---> " + calculated_number_of_candidates_with_D_plus);
        System.out.println ("                D  ---> " + calculated_number_of_candidates_with_D_plain);
        System.out.println ("                D- ---> " + calculated_number_of_candidates_with_D_minus);
        System.out.println ("                E  ---> " + calculated_number_of_candidates_with_E);
        System.out.println ("                P  ---> " + calculated_number_of_candidates_with_P);
        System.out.println ("                U  ---> " + calculated_number_of_candidates_with_U);
        System.out.println ("                W  ---> " + calculated_number_of_candidates_with_W);
        System.out.println ("                X  ---> " + calculated_number_of_candidates_with_X);
        System.out.println ("                Y  ---> " + calculated_number_of_candidates_with_Y);
        System.out.println ("                Z  ---> " + calculated_number_of_candidates_with_Z + "\n");
...
{   try 
     {
       ...
       File file_Text_File = new File(Analysis_File_name  );
...
{   try 
     {
            ...
            FileReader Analyze_Subjects_KCSE_FileReader = new FileReader("DB@254@2015KCSE.txt");   
