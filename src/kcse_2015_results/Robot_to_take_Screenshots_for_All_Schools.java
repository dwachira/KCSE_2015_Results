...
public void Robot_to_take_Screenshots_for_All_Schools() 
{
      try
      {
            FileReader KCSE_FileReader = new FileReader("C:\\Users\\Wachira\\Documents\\Netbeans_7_point_4_Projects\\KCSE_2015_Results\\DB@254@2015KCSE.txt");
...
{   try 
     {
       ...
       File file_Text_File = new File("./Robot - All Candidates/kcse_2015_candidates.txt");
    ...
    try 
       {    
            ...
            FileReader KCSE_Results_Student_Details_FileReader = new FileReader("C:\\Users\\Wachira\\Documents\\Netbeans_7_point_4_Projects\\KCSE_2015_Results\\DB@254@2015KCSE.txt");
...
{                                                                     
        ...
        final KCSE_2015_Bar_Chart KCSE_2015_bar_chart = new KCSE_2015_Bar_Chart("KCSE 2015 Results - "+ Student_full_name, "KCSE 2015 Results - "+ Student_full_name+" ("+ KNEC_Candidate_s_index_number +")", ary_dataset_bar_chart);
        ...
        WindowFocusListener windowFocusListener = new WindowFocusListener()
        {
            ...
            {   
                ...
                System.out.println("Bar_Chart_KCSE_pie_chart - windowGainedFocus()");
                 ...
                 Bar_Chart_fileName = Bar_Chart_fileName + "Candidate's KCSE 2015 Results - "+ Student_full_name+"("+ KNEC_Candidate_s_index_number +")" + " - " + Bar_Chart_date_time_of_screenshot +" by David Wachira.png";
...
/* **************************************************************************************************************** */
        ...
        KCSE_2015_bar_chart.setSize(width,height);
